...
{
    public class VariableType_PowerOn_1065183424_0 : CodeGenVariableTypeBase
    {
        public VariableType_PowerOn_1065183424_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_PowerOn_1065183424_0::Initialize");
            ...
            this.GetNode().BrowseName  = "PowerOn";
            this.GetNode().DisplayName = "PowerOn";
            ...
            string defaultValueType = "Boolean";
            if (setDefaultValue)
            {
                try
                {

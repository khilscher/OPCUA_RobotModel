...
{
    public class VariableType_Manufacturer_98866125_0 : CodeGenVariableTypeBase
    {
        public VariableType_Manufacturer_98866125_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Manufacturer_98866125_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Manufacturer";
            this.GetNode().DisplayName = "Manufacturer";
